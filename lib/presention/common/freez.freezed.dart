...
class _$_RegisterObject implements _RegisterObject {
  _$_RegisterObject(this.userName, this.countryMobileCode, this.mobile,
  ...
  @override
  String toString() {
    return 'RegisterObject(userName: $userName, countryMobileCode: $countryMobileCode, mobile: $mobile, email: $email, password: $password, profilePicture: $profilePicture)';
  }
